...
from panda.core.gitutil import GIT_HOST
...
@click.option("--no-auto-init", is_flag=True, help="Create an empty repo")
def repo_create(
    name: str,
    ...
    click.echo(
       f"  Clone URL: https://{GIT_HOST}/git/{username}/{name}.git"
    )
