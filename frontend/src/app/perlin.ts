// Simple 2D Perlin Noise implementation (public domain adaptation)
...
/**
 * Sample a 2‑D Perlin noise field.
 * Returns a normalized direction vector {dx, dy} in the range [-1, 1].
 */
export function sample(x: number, y: number, scale: number = 0.003): { dx: number; dy: number } {
